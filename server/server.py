...
pub_key = 'pub-c-d06e5664-54b8-441f-87b3-5a23cb9bf3d9'
sub_key = 'sub-c-f7c23bd8-1732-11e6-84f2-02ee2ddab7fe'
	...
	if (session_expiry == False and loggedin == True):
		...
		if (session_expiry == True):
			...
			try:
				...
				logging.error("The error_expirerecover_addbook exception is %s,%s -->CLIENT %s"%(error_expirerecover_addbook,details['DISPLAY_NAME']))
	...
	if (session_expiry == False and loggedin == True):
		...
		if (session_expiry == True):
			...
			try:
				...
				logging.error("The error_expirerecover_tasklist exception is %s,%s -->CLIENT %s"%(error_expirerecover_tasklist,type(error_expirerecover_tasklist),details['DISPLAY_NAME']))
	...
	if (session_expiry == False and loggedin == True):
		...
		if (session_expiry == True):
			...
			try:
				...
				logging.error("oops! The error_expirerecover_taskdetails exception is %s,%s -->CLIENT %s"%(error_expirerecover_taskdetails,type(error_expirerecover_taskdetails),details['DISPLAY_NAME']))
	...
	if (session_expiry == False and loggedin == True):	
		...
		if (session_expiry == True):
			...
			try:
				...
				logging.error("The error_expirerecover_newtask exception is %s,%s -->CLIENT %s "%(error_expirerecover_newtask,type(error_expirerecover_newtask),details['DISPLAY_NAME']))
	...
	if (session_expiry == False and loggedin == True):	
		...
		if (session_expiry == True):
			...
			try:
				...
				logging.error("The error_expirerecover_comment exception is %s,%s -->CLIENT %s"%(error_expirerecover_comment,type(error_expirerecover_comment),details['DISPLAY_NAME']))
