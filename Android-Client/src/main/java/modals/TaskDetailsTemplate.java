 ...
 */
public class TaskDetailsTemplate {
    ...
    private ArrayList<CommentTemplate> comments=new ArrayList<CommentTemplate>();
    ...
    public ArrayList<CommentTemplate> getComments() {
        return comments;
    }

    public void setComments(ArrayList<CommentTemplate> comments) {
