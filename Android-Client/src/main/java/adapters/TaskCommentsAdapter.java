...
public class TaskCommentsAdapter  extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.mTxtVwCommentText.setText(taskComments.get(i).getCOMMENT_DESCRIPTION());
        holder.mTxtVwCommentPostedOn.setText("Posted On: "+taskComments.get(i).getCOMMENT_CREATION_DATE());
        holder.mTxtVwCommentPostedBy.setText("Posted By: "+taskComments.get(i).getDISPLAY_NAME());
        return view;
    }
